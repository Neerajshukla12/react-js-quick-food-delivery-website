    ...
    <div className="container-fluid pt-5 bg-footer">
          ...
          <div className="col-lg-3 col-md-3 col-sm-12">
            ...
            <div className="footer-list-div">
              <ul>
                ...
                <li><a href="#">Matar Paneer</a></li>
                <li><a href="#">Shahi Paneer</a></li>
                <li><a href="#">Burger</a></li>
                <li><a href="#">Dosha</a></li>
                <li><a href="#">Steam Momo</a></li>
      ...
      <div className="container">
        <div className="col-12 footer-copyright">
          <p>
            © 2025 Quick Food. All Rights Reserved. Powered By{' '}
            <span style={{ color: '#eb6825', fontWeight: 700 }}>Neeraj Shukla</span>
          </p>
        </div>
      </div>
    </div>
